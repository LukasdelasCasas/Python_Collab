...
from hw03_perceptron.utils import DataInstance, Dataset
from hw03_perceptron.perceptron_classifier import PerceptronClassifier
...
def main(argv):
    # python3 -m hw03_perceptron.spam_classification -p data/enron/enron1/ham/ -n data/enron/enron1/spam/ -pp data/enron/enron2/ham/ -nn data/enron/enron2/spam/ -ppp data/enron/enron3/ham/ -nnn data/enron/enron3/spam/
