...
from hw04_paraphrases.utils import DataInstance, Dataset, normalized_tokens
from hw04_paraphrases.perceptron_classifier import PerceptronClassifier
...
def token_ngrams(tokens, n):
    """ Returns a list of word n-grams (strings)."""
    # TODO Exercise 1.1
    return []
